...
export default function AdminDashboard() {
  ...
  if (loading) {
    return (
      <motion.div 
        className="max-w-[80rem] mx-auto pb-16 pt-4 space-y-10"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-4 w-full">
            <div className="w-2/3 max-w-[400px] h-10 rounded-lg bg-secondary/40 animate-pulse" />
            <div className="w-1/2 max-w-[300px] h-6 rounded-lg bg-secondary/40 animate-pulse" />
          </div>
          <div className="w-32 h-10 rounded-lg bg-secondary/40 animate-pulse shrink-0" />
        </div>
        ...
        <motion.div 
          ...
          className="space-y-6"
        >
          <div className="w-48 h-8 rounded-lg bg-secondary/40 animate-pulse" />
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="flex flex-col h-full bg-card border border-border rounded-xl overflow-hidden min-h-[220px]">
                <div className="p-6 flex-1 flex flex-col gap-4">
                  <div className="flex justify-between items-start">
                    <div className="w-10 h-10 rounded-lg bg-secondary/40 animate-pulse" />
                    <div className="w-16 h-6 rounded bg-secondary/40 animate-pulse" />
                  </div>
                  <div className="space-y-2 mt-2">
                    <div className="w-3/4 h-6 rounded bg-secondary/40 animate-pulse" />
                    <div className="w-full h-4 rounded bg-secondary/40 animate-pulse" />
                    <div className="w-5/6 h-4 rounded bg-secondary/40 animate-pulse" />
                  </div>
                </div>
                <div className="px-6 py-4 border-t border-border bg-secondary/5 flex items-center justify-between">
                  <div className="flex gap-2">
                    <div className="w-16 h-6 rounded bg-secondary/40 animate-pulse" />
                  </div>
                  <div className="w-4 h-4 rounded bg-secondary/40 animate-pulse" />
                </div>
              </div>
            ))}
          </div>
