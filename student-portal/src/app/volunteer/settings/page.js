    ...
    <div className="max-w-3xl mx-auto pb-16 pt-4 space-y-8">
      <motion.div initial="hidden" animate="show" variants={fadeUp} className="space-y-6">
        <div>
          ...
          <p className="text-lg text-muted-foreground font-medium mt-1">Manage your reviewer account.</p>
        </div>
              ...
              <div className="p-6 md:p-8 border-b border-border">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Update the name shown to students and admins</p>
                  </div>
                </div>
